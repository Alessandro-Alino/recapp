...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppResponse<T>);
}
...
/// @nodoc
class $AppResponseCopyWith<T,$Res>  {
$AppResponseCopyWith(AppResponse<T> _, $Res Function(AppResponse<T>) __);
}


/// Adds pattern-matching-related methods to [AppResponse].
extension AppResponsePatterns<T> on AppResponse<T> {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( String message,  int? code)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( String message,  int? code)  failure,}) {final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( String message,  int? code)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.message,_that.code);case _:
...
@override
String toString() {
  return 'AppResponse<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AppResponseCopyWith<T, $Res> {
...
class Failure<T> extends AppResponse<T> {
  const Failure({required this.message, this.code}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Failure<T>&&(identical(other.message, message) || other.message == message)&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'AppResponse<$T>.failure(message: $message, code: $code)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $AppResponseCopyWith<T, $Res> {
